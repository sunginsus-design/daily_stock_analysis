...
以下代码必须优先按固定映射识别，不得由模型自行猜测：

- 6315.T = TOWA Corporation / TOWA株式会社 / TOWA
- 6135.T = Makino Milling Machine / 牧野フライス製作所
- 4063.T = Shin-Etsu Chemical / 信越化学
- 3436.T = SUMCO
...
特别注意：
6315.T 是 TOWA，不是牧野フライス製作所。牧野フライス製作所的代码是 6135.T。
如果输入代码与模型记忆中的公司名称冲突，必须以本表为准。
